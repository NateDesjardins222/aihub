...
export const TOOLS: readonly ToolDef[] = [
  ...
  // --- V4 catalog: fixed-anchor geometry tools ----------------------------
  {
    kind: 'INFO_LINE',
    name: KIND_LABEL.INFO_LINE,
    family: 'LINES',
    anchors: ANCHOR_COUNT.INFO_LINE,
    style: {},
    options: {},
    props: [COLOR, WIDTH, DASH, FONT_SIZE],
  },
  {
    kind: 'TREND_ANGLE',
    name: KIND_LABEL.TREND_ANGLE,
    family: 'LINES',
    anchors: ANCHOR_COUNT.TREND_ANGLE,
    style: {},
    options: {},
    props: [COLOR, WIDTH, DASH, FONT_SIZE],
  },
  {
    kind: 'ARROW_MARKER',
    name: KIND_LABEL.ARROW_MARKER,
    family: 'ARROWS',
    anchors: ANCHOR_COUNT.ARROW_MARKER,
    style: {},
    options: {},
    props: [COLOR, WIDTH, DASH],
  },
  {
    kind: 'ARROW_MARK_UP',
    name: KIND_LABEL.ARROW_MARK_UP,
    family: 'ARROWS',
    anchors: ANCHOR_COUNT.ARROW_MARK_UP,
    style: {},
    options: {},
    props: [COLOR],
  },
  {
    kind: 'ARROW_MARK_DOWN',
    name: KIND_LABEL.ARROW_MARK_DOWN,
    family: 'ARROWS',
    anchors: ANCHOR_COUNT.ARROW_MARK_DOWN,
    style: {},
    options: {},
    props: [COLOR],
  },
  {
    kind: 'ARROW_MARK_LEFT',
    name: KIND_LABEL.ARROW_MARK_LEFT,
    family: 'ARROWS',
    anchors: ANCHOR_COUNT.ARROW_MARK_LEFT,
    style: {},
    options: {},
    props: [COLOR],
  },
  {
    kind: 'ARROW_MARK_RIGHT',
    name: KIND_LABEL.ARROW_MARK_RIGHT,
    family: 'ARROWS',
    anchors: ANCHOR_COUNT.ARROW_MARK_RIGHT,
    style: {},
    options: {},
    props: [COLOR],
  },
  {
    kind: 'CIRCLE',
    name: KIND_LABEL.CIRCLE,
    family: 'SHAPES',
    anchors: ANCHOR_COUNT.CIRCLE,
    style: {},
    options: {},
    props: [BORDER, FILL_COLOR, WIDTH, DASH],
  },
  {
    kind: 'PRICE_RANGE',
    name: KIND_LABEL.PRICE_RANGE,
    family: 'MEASURE',
    anchors: ANCHOR_COUNT.PRICE_RANGE,
    style: {},
    options: {},
    props: [COLOR, WIDTH, FONT_SIZE],
  },
  {
    kind: 'DATE_RANGE',
    name: KIND_LABEL.DATE_RANGE,
    family: 'MEASURE',
    anchors: ANCHOR_COUNT.DATE_RANGE,
    style: {},
    options: {},
    props: [COLOR, WIDTH, FONT_SIZE],
  },
  {
    kind: 'ANCHORED_TEXT',
    name: KIND_LABEL.ANCHORED_TEXT,
    family: 'ANNOTATION',
    anchors: ANCHOR_COUNT.ANCHORED_TEXT,
    style: {},
    options: {},
    props: [COLOR, FONT_SIZE, { key: 'text', label: 'Text', type: 'TEXT', on: 'TEXT', group: 'Text' }],
  },
  {
    kind: 'NOTE',
    name: KIND_LABEL.NOTE,
    family: 'ANNOTATION',
    anchors: ANCHOR_COUNT.NOTE,
    style: {},
    options: {},
    props: [COLOR, FONT_SIZE, { key: 'text', label: 'Text', type: 'TEXT', on: 'TEXT', group: 'Text' }],
  },
